...
define i32 @main(i32 %argc, i8** %argv) {
  ...
  store i32 %top_19, i32* @.BL
  call void @Stack_PushInt(%stackType* %stack, i32 4)
  %top_20 = call i32 @Stack_Pop(%stackType* %stack)
  store i32 %top_20, i32* @.NB
  call void @Stack_PushInt(%stackType* %stack, i32 12)
  %top_21 = call i32 @Stack_Pop(%stackType* %stack)
  store i32 %top_21, i32* @.DATA
  %var_local_22 = load i32, i32* @.DATA
  call void @Stack_PushInt(%stackType* %stack, i32 %var_local_22)
  %top_23 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_24 = call i32 @printInt(i32 %top_23)
  %var_local_25 = load i32, i32* @.NB
  call void @Stack_PushInt(%stackType* %stack, i32 %var_local_25)
  %top_26 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_27 = call i32 @printInt(i32 %top_26)
  call void @Stack_PushInt(%stackType* %stack, i32 543)
  %top_28 = call i32 @Stack_Pop(%stackType* %stack)
  store i32 %top_28, i32* @.NB
  %var_local_29 = load i32, i32* @.NB
  call void @Stack_PushInt(%stackType* %stack, i32 %var_local_29)
  ...
  store i32 %top_32, i32* @.TWENTY
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_33 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_34 = call i32 @printInt(i32 %top_33)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_35 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_36 = call i32 @printInt(i32 %top_35)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  %printTop_40 = call i32 @printInt(i32 %top_39)
  ...
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_47 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_48 = call i32 @printInt(i32 %top_47)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_49 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_50 = call i32 @printInt(i32 %top_49)
  %top_51 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_52 = call i32 @printInt(i32 %top_51)
  call void @Stack_PushInt(%stackType* %stack, i32 5)
  call void @Stack_Function_SPACES(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_53 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_54 = call i32 @printInt(i32 %top_53)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_55 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_56 = call i32 @printInt(i32 %top_55)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_57 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_58 = call i32 @printInt(i32 %top_57)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_59 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_60 = call i32 @printInt(i32 %top_59)
  ...
  %printTop_64 = call i32 @printInt(i32 %top_63)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_65 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_66 = call i32 @printInt(i32 %top_65)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_67 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_68 = call i32 @printInt(i32 %top_67)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  %printTop_72 = call i32 @printInt(i32 %top_71)
  call void @Stack_PushInt(%stackType* %stack, i32 5)
  call void @Stack_Function_SPACES(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_75 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_76 = call i32 @printInt(i32 %top_75)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_77 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_78 = call i32 @printInt(i32 %top_77)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  %printTop_82 = call i32 @printInt(i32 %top_81)
  call void @Stack_PushInt(%stackType* %stack, i32 5)
  call void @Stack_Function_SPACES(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_83 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_84 = call i32 @printInt(i32 %top_83)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_85 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_86 = call i32 @printInt(i32 %top_85)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_87 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_88 = call i32 @printInt(i32 %top_87)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_89 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_90 = call i32 @printInt(i32 %top_89)
  %top_91 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_92 = call i32 @printInt(i32 %top_91)
  call void @Stack_PushInt(%stackType* %stack, i32 5)
  call void @Stack_Function_SPACES(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_95 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_96 = call i32 @printInt(i32 %top_95)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  %top_97 = call i32 @Stack_Pop(%stackType* %stack)
  %printTop_98 = call i32 @printInt(i32 %top_97)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  call void @Stack_Function_TWENTY(%stackType* %stack, %stackType* %return_stack)
  ...
  %printTop_102 = call i32 @printInt(i32 %top_101)
  call void @Stack_PushInt(%stackType* %stack, i32 5)
  call void @Stack_Function_SPACES(%stackType* %stack, %stackType* %return_stack)
